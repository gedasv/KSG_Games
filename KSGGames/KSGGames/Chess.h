	...
	private: System::Void botMove()
	{
		...
		if (nextBotMove(Chess_Board, move, 2))
		{
			...
			for (int i = 0; i < 8; i++)
			{
				for (int j = 0; j < 8; j++)
				{
					if (j == 7 && Chess_Board[i][j].Type() == "Pawn") Chess_Board[i][j].SetType("Queen");
					std::string picture = Chess_Board[i][j].Team() + Chess_Board[i][j].Type() + ".Image";
					String^ pictureS = gcnew String(picture.c_str());
					Board[i, j] = addPieceImg(Board[i, j], pictureS);
				}
			}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->winText = (gcnew System::Windows::Forms::Label());
			this->SuspendLayout();
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(768, 641);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(140, 67);
			this->button1->TabIndex = 16;
			this->button1->Text = L"Switch sides";
			...
			this->winText->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 30, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->winText->Location = System::Drawing::Point(155, 266);
			this->winText->Name = L"winText";
			this->winText->Size = System::Drawing::Size(309, 46);
			this->winText->TabIndex = 17;
			this->winText->Text = L"WHITE WINS!!!";
