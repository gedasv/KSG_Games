...
namespace KSGGames {
	...
	private: System::Windows::Forms::Button^  game4Button;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->game4Button = (gcnew System::Windows::Forms::Button());
			...
			this->gamesPanel->Controls->Add(this->game4Button);
			...
			// game4Button
			// 
			this->game4Button->BackColor = System::Drawing::Color::Transparent;
			this->game4Button->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"game4Button.BackgroundImage")));
			this->game4Button->Enabled = false;
			this->game4Button->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
			this->game4Button->Font = (gcnew System::Drawing::Font(L"Rockwell", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->game4Button->Location = System::Drawing::Point(67, 440);
			this->game4Button->Name = L"game4Button";
			this->game4Button->Size = System::Drawing::Size(291, 58);
			this->game4Button->TabIndex = 7;
			this->game4Button->Text = L"GAME4";
			this->game4Button->UseVisualStyleBackColor = false;
			// 
			// game3Button
			// 
